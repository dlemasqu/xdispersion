...
def bootstrap(func, args, kwargs, ensemble=1000, CI=0.95):
...
def gen_rbins(r_lower, r_upper, alpha=1.2, thre=None, incre=None):
...
def mean_at_rbin(var, r, rbins, cond=None):
...
def sum_at_rbin(var, r, rbins, cond=None):
