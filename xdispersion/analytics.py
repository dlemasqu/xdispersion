...
class TwoParticleStatistics(object):
    """
    This class is designed as a basis for two-particle statistical analysis.
    """
    def __init__(self, xpos, ypos, uvel, vvel, time, coord, Rearth=6371.2):
        """
        Construct a ParticleStatistics class
    ...
    def analytic_K2(self, r, params, regime):
    ...
    def analytic_S2(self, r, params, regime):
    ...
    def analytic_S3(self, r, params, regime):
    ...
    def analytic_r2(self, r, params, regime):
    ...
    def analytic_Kurtosis(self, r, params, regime):
    ...
    def analytic_PDF(self, r, t, params, regime):
    ...
    def analytic_CIST(self, r, alpha, params, regime):
    ...
    def numerical_r2(self, PDF, scaled2PiR=False):
        """Calculate relative dispersion numerically from full PDF
        ...
        """
        if scaled2PiR:
            r2 = (PDF * PDF.r**2).integrate('r')
        else:
            r2 = (2 * np.pi * PDF * PDF.r**3).integrate('r')
        
        return r2.rename('r2')
    
    def numerical_Kurtosis(self, PDF, scaled2PiR=False):
        """Calculate kurtosis numerically from full PDF
        ...
        """
        if scaled2PiR:
            r4 = (PDF * PDF.r**4).integrate('r')
            r2 = (PDF * PDF.r**2).integrate('r')
            Ku = r4 / (r2)**2
        else:
            r4 = (2 * np.pi * PDF * PDF.r**5).integrate('r')
            r2 = (2 * np.pi * PDF * PDF.r**3).integrate('r')
            Ku = r4 / (r2)**2
        
        return Ku.rename('Ku')
    
    def numerical_K2(self, PDF, scaled2PiR=False):
        """Calculate CIST numerically from full PDF
    ...
    def numerical_CIST(self, PDF, lower, upper, maskout=[1e-6, 1e2], scaled2PiR=False):
        """Calculate CIST numerically from full PDF
        ...
        if scaled2PiR:
            ...
            CDF = self.CDF(PDF * 2 * np.pi * PDF.r)
        
        cist = self.CIST(CDF, lower, upper, maskout=maskout)
